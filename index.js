...
async function boasVindas() {
    ...
    console.log("Você acaba de chegar à cidade de Terras Obscuras, um lugar repleto de mistérios e desafios.");
    await delay(4000); 

    console.log("Prepare-se para uma nova jornada repleto de desafios.");
    await delay(4000);
...
function comprarPocaoCura() {
    if (jogador.gold >= 10) {
        jogador.gold -= 10;
        jogador.hp += 15; // Recupera 10 pontos de vida
...
function comprarPocaoDano() {
    if (jogador.gold >= 10) {
        ...
        console.log("Não tem ouro suficiente.");
    }
}
...
const monstros = [
    ...
    { nome: "Zumbi", hp: 23, forca: 9, xp: 95 },
...
function ganharXP(xpGanho) {
    ...
    while (jogador.xp >= jogador.nivel * 100) {
        ...
        console.log(`Boaaa!!! Você conseguiu subir para o level ${jogador.nivel} e ganhou 5 pontos de vida.`);
    }
}
...
async function jogo() {
    ...
    console.log("Qual classe você deseja?.\n[1] Mago\n[2] Arqueiro\n[3] Guerreiro\n[4] Bardo");
    ...
    switch (escolhaClasse) {
        ...
        case 2:
            ...
            jogador.mag += 5;
            jogador.des += 20;
            jogador.inventario = ["arco", "flecha", "chapéu de arqueiro"];
            break;
        case 3:
    ...
    while (jogadorEstaVivo()) {
        ...
        console.log("[2] Ver meus itens inventário");
        console.log("[3] Ver meus atributos");
        console.log("[4] Comprar poção de dano (20 de ouro)");
        console.log("[5] Comprar poção de cura (10 de ouro)");
        console.log("[6] Encerrar jogo");
    ...
    console.log("Acabou! - Você perdeu!!!");
}
